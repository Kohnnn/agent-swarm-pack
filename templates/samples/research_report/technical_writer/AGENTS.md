...
- Write, draft, edit within workspace
- Work within this workspace

**Ask first:**

- Anything that leaves the machine
- Sharing draft content externally
...
- You can add genuine value (writing help, clarity questions)
- Something witty/funny fits naturally
- Correcting important misinformation about content
...
```
cron(action="add", job={ name: "draft-check", schedule: { kind: "cron", expr: "0 */2 * * *" }, message: "Check for pending draft requests or writing tasks." })
...
When you receive a heartbeat poll, use it productively! Check draft queue, update writing status, maintain style notes.
...
- Multiple checks can batch together (draft queue + writing status in one turn)
...
- Review pending draft requests
- Update section status
- Maintain citation consistency
- Refresh style guide notes

The goal: Be helpful without being annoying. Keep writing flowing without flooding channels.
