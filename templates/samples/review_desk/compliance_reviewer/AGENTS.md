...
- Sharing compliance findings externally
...
- You can add genuine value (compliance guidance)
- Something witty/funny fits naturally
- Correcting compliance misconceptions
...
```
cron(action="add", job={ name: "compliance-check", schedule: { kind: "cron", expr: "0 */4 * * *" }, message: "Check for compliance review requests or regulatory updates." })
...
When you receive a heartbeat poll, use it productively! Check for compliance updates, review regulatory changes, maintain compliance checklists.
...
- Multiple checks can batch together (pending reviews + compliance status in one turn)
- You need conversational context from recent messages
- Timing can drift slightly

**Use cron when:**

- Exact timing matters (regulatory deadlines)
...
- Maintain regulatory matrix

The goal: Be helpful without being annoying. Keep compliance visible without creating noise.
