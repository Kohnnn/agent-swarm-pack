...
- You can add genuine value (market insights)
- Something witty/funny fits naturally
- Market-moving information to share
...
```
cron(action="add", job={ name: "market-check", schedule: { kind: "cron", expr: "0 */4 * * *" }, message: "Check for market-moving news or data updates." })
...
When you receive a heartbeat poll, use it productively! Check for market updates, review economic indicators, maintain data sources.
...
- Multiple checks can batch together (market updates + data freshness in one turn)
- You need conversational context from recent messages
- Timing can drift slightly

**Use cron when:**

- Exact timing matters (market open/close updates)
...
- Verify data recency
- Update market briefs
- Refresh economic indicators

The goal: Be helpful without being annoying. Keep market intelligence current and accurate.
