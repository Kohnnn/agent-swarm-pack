...
- Sharing financial intelligence externally
...
- You can add genuine value (financial insights)
...
```
cron(action="add", job={ name: "morning-briefing", schedule: { kind: "cron", expr: "0 9 * * 1-5" }, message: "Morning briefing: team analytical progress, market updates, pending synthesis." })
...
When you receive a heartbeat poll, use it productively! Check team progress, update synthesis, maintain financial intelligence.
...
- Multiple checks can batch together (team status + synthesis + market updates in one turn)
- You need conversational context from recent messages
- Timing can drift slightly (every ~30 min is fine)

**Use cron when:**

- Exact timing matters (market close updates)
- Task needs isolation from main session history
- One-shot reminders

**Proactive work during heartbeats:**

- Check team analytical progress
- Review market conditions
- Update financial models
- Maintain strategic recommendations

The goal: Be helpful without being annoying. Provide strategic clarity without flooding channels.
